...
class FbChatMock {
    ...
    private $_dbHost = 'wicsqlserver.database.windows.net';
    private $_dbUsername = 'wic';
    private $_dbPassword = '#$youcandoit2017$#';
    public $_databaseName = 'wicdb';
...
//        }
        $this->dbConnection = new PDO("sqlsrv:server=$_dbHost; Database=$_databaseName", "$_dbUsername", "$_dbPassword");

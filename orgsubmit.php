...
if ($arg === 'addOrganization') {
    ...
    try {
        ...
        echo "<table class='table table-striped' id='mytable'><tr><th> Name </th><th> Phone Number </th><th> Mobile </th><th> Address </th><th> Facebook </th><th> Twitter </th><th> Linkdin </th> <th>Email</th><th>Website</th><th>Delete</th><th>Edit</th></tr>";     
//echo "<table class='table table-striped' id='mytable'><tr><th> ID </th><th> UserId </th><th> Name </th><th> Boss </th><th> Date Created </th><th> Addres </th><th> Delete </th> <th>Edit</th></tr>";
        ...
        //echo '<input type="hidden" name="UserId" value="'.$row['User_Boss'].'"> ';
            echo '<input type="hidden" name="Org" value="'.$row['Id'].'"> ';

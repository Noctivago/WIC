        ...
        <div class="row" style="height: 700px;">
            <div class="col-lg-6">
                <section class="box-typical box-typical-max-280">
                    ...
                    <div class="box-typical-body" style="overflow: hidden; width: 494px; padding: 0px; height: 700px;">
...
<script>
    ...
    function addWic(wicId) {
        ...
        if (document.getElementById("name") !== null) {
            alert('!NULL > TTF #>' + document.getElementById("name").value + ' < + DATE > ' + document.getElementById("daterange3").value);
        }
        if (wicName !== "") {
            $.ajax({

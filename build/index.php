    ...
    <div class="container-fluid">
        ...
        if (isset($_GET ['PageNum'])) {
            ...
            $query .= '<div class="form-group" style="padding-left:35px;">'
                    . '<span  class="label label-primary" style="width: 91.2px; height: 27px; padding-top: 5px;" disable> Page <span sytle="color:red">&raquo</span> ' . ($PageNum + 1) . ' </span>';
        } else {
            echo '<script>updateQueryStringParameter("PageNum","0"); </script>';
        ...
        if (isset($_GET ['name'])) {
            ...
            $query .= '<span  class="label label-primary" style="width: 91.2px; height: 27px; padding-top: 5px;" disable>#City <span sytle="color:red">&raquo</span> ' . $city . '</span> ';
        }
        /**
...
//        botao reset
        ...
        if (isset($_GET ['qParam']) || isset($_GET ['name']) || isset($_GET ['PageNum']) || isset($_GET ['Category']) || isset($_GET ['SubCategory'])) {
            $clear = '<a style="width: 91.2px; height: 27px; padding-top: 5px; border-left-width:5px;" class="label label-danger" href="index.php"> Reset</a>'
                    . '</div>';
        } else {
            $clear = '';
        }

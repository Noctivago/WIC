    ...
    <div class="container-fluid">
        ...
        if (isset($_GET ['PageNum'])) {
            ...
            $query .= '<div class="form-group" style="padding-left:35px;">'
                    . '<span  class="btn btn-inline" disable style="width: 91.2px; height: 27px; padding-top: 5px;" disable> Page <span sytle="color:red">&raquo</span> ' . ($PageNum + 1) . ' </span>';
        } else {
            echo '<script>updateQueryStringParameter("PageNum","0"); </script>';
...
//        botao reset
        ...
        if (isset($_GET ['qParam']) || isset($_GET ['name']) || isset($_GET ['PageNum']) || isset($_GET ['Category']) || isset($_GET ['SubCategory'])) {
            $clear = '<a style="width: 91.2px; height: 27px; padding-top: 5px; border-left-width:5px;" class="btn btn-rounded btn-inline btn-secondary" href="index.php"> Reset</a>'
                    . '</div>';
        } else {
            $clear = '';
        }

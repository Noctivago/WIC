    ...
    try {
        ...
        foreach ($rows as $row) {
            ...
            echo '<div data-p="144.50"  >
                <img  style="display: block; top: 0px; left: 0px; max-width: 800px; max-height: 356px;  margin: 0px auto; width: auto; height:auto; position: static;" data-u="image" id="' . $count . '" src="' . $row['Multimedia_Path'] . '" />

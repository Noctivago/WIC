...
Function DB_getMyWicsAsPopup($pdo, $userId) {
    try {
        ...
        if (DB_checkIfUserHaveWicPlanner($pdo, $userId)) {
            echo '<div class="title-label" style="align:center;"> <button class="btn btn-rounded btn-inline btn-primary" href ><a href="my_wicplanner.php"><i class="font-icon font-icon-plus "></i>&ensp;New Event</a></button></div>
                <h6>WiC Planner - The notepad for event planners</h6>
                <header class="sign-title">Adress to an existent one</header>';

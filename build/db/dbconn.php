...
<td>
            ...
            if ($row['Role_Id'] === '4') {
                ...
                . '<input type="checkbox" id="edit' . $row['ID'] . '" name="permission" checked="checked"> To edit Service <br> <input type="checkbox" id="talk' . $row['ID'] . '" checked="checked"> Talk with costumers  '
                        . '</div>';

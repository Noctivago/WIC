...
<div class = "tbl-cell">
<p class = "user-card-row-name" style="overflow: hidden;height: 70px;"><a href = "profile_org.php?Organization=' . $row['OID'] . '">' . $row['ONA'] . '</a></p>
</div>
</div>
</div>
</div>
...
<button class="btn btn-rounded btn-inline btn-primary-outline font-icon-plus" style="width: 41px;height: 29px;border-color:white;    padding-left: 10px;padding-right: 10px;padding-top: 3px;"  onClick = "openMyWics(' . $row['SID'] . ');" </button>
<button class="btn btn-rounded btn-inline btn-warning font-icon-comment" style="width: 41px;height: 29px;padding-left: 10px;padding-right: 10px;padding-top: 3px;"  onClick = "openMyWics(' . $row['SID'] . ');" </button>

...
<i class="font-icon font-icon-plus" alt="Add to my Wic Planner">
...
<button class="btn font-icon-plus" type = button onClick = window.open("./ajax/getMyWicsPopup.php?id=' . $row['SID'] . '", "AddToWiC", "width=550,height=500,left=30,top=30,toolbar=0,status=0,");  ><i class="font-icon font-icon-user"></i> </button>

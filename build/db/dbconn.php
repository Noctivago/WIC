...
function DB_GetOrganizationServices($pdo, $org, $idUser) {
	...
	AND [Organization].[Id] = ?", array($org), "rows");
        foreach ($rows as $row) {
            ...
            echo '<div class = "slide">';
            echo '<article class = "post-announce" style="width:200px; heigth:200px;">';
            echo '<div class = "post-announce-pic" style="width:200px; heigth:200px;">';
            echo '<a href = "service_profile.php?Service='.$row['SID'].'">';
            echo ' <img src = "'.$row['MPP'].'" alt = ""style="width:200px; heigth:200px;" >';
            echo '</a>';
            echo ' </div>';
            echo '<div class = "post-announce-title">';

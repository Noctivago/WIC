...
function db_getWicsForHeader($pdo, $userId) {
    try {
        ...
        foreach ($rows as $row) {
            ...
            echo '<span class="mess-item-name" ><i class="font-icon font-icon-calend" style="padding-right:5px;"></i>' . $row['Name'] . ' <i class="font-icon font-icon-arrow-right"></i> ' . $subStr[0] . '</span>';

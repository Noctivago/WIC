...
<div class="container-fluid">
    ...
    <div class="sign-box">
        <div class="title-label" style="align:center;"> <span><i class="font-icon font-icon-plus" style="align:rigth"> New Event</i></span><h3 style="padding-left: 70px; color: blue;"><i class="font-icon font-icon-plus"></i>New Event</h3></div>

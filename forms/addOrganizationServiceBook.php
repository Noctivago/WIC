...
<html lang="en">
    ...
    <head>
        ...
        <title>NEW ORGANIZATION SERVICE BOOK</title>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>NEW ORGANIZATION SERVICE BOOK</strong> </h1>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-box">
                                <div class="form-bottom">
                                    <?php
                                    if (isset($_POST['addOrgSerBook']) && !empty($_POST['name']) && !empty($_POST['org_ser_id'])) {
                                        $msg = '';
                                        try {
                                            $d = getDateToDB();
                                    ...
                                    <form role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="login-form">
                                        <div class="form-group"><h4> <?php echo $msg; ?></h4>
                                            <input type="text" name="name" placeholder="ORGANIZATION SERVICE BOOK NAME" class="form-username form-control" id="name" required autofocus>
                                        </div>

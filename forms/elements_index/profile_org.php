                    ...
                    <div class="form-box">
                        <div class="form-top">
                            ...
                            <img src="http://lyco.com.br/site/empresa/images/icone_grande_empresa-2.png" class="avatar img-circle img-thumbnail text-center center-block" alt="avatar">
                                <input style="color: black; width: 370px; align:center-left; " class="form-username form-control" type="file">
                                <!--<h6 style="color:black">Upload a different photo...</h6>   text-left center-block well well-sm-->
                    ...
                    <div class="form-box">
                        <div class="form-top">
                            ...
                            <div class="form-top-right">
                                ...
                                <img src="http://lyco.com.br/site/empresa/images/icone_grande_empresa-2.png" class="avatar img-circle img-thumbnail text-center center-block" alt="avatar">
                                <input style="color: black; width: 370px;align:center-left;" class="text-left center-block well well-sm" type="file">
